...
geneModels.i.coding.gff3\t对geneModels.h.coding.gff3中的基因模型进行了强制补齐\n";
    ...
    my $cmdString1 = "$dirname/bin/paraCombineGeneModels $config{'paraCombineGeneModels'} --cpu $cpu ../3.maker_pred/maker_gene.gff3 ../6.augustus/augustus.gff3 ../4.transcript/transfrag.genome.gff3 ../5.homolog/genewise.gff3 ../6.augustus/hints.gff &> /dev/null";
...
# Step 8: GETA OutPut
print STDERR "\n============================================\n";
print STDERR "Step 8:GETA OutPut " . "(" . (localtime) . ")" . "\n";
    chdir "../";
    $pwd = `pwd`; print STDERR "PWD: $pwd";
